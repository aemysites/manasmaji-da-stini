...
## Environments
- Preview: https://main--manasmaji-da-stini--aemysites.aem.page/
- Live: https://main--manasmaji-da-stini--aemysites.aem.live/
...
1. Open the `manasmaji-da-stini` directory in your favorite IDE and start coding :)
